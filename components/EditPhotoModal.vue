<template>
    ...
    <div class="modal">
        ...
        <div class="modal-content">
            ...
            <!-- Close button -->
            <UiButtonCloseSm @click="closeModal('photoModal')" class="close"/>
            <!-- Close button -->
            ...
            <div class="modal-container">
                ...
                <div>
                    ...
                    v-model="imageUrl"
                    />
                    <button @click="addPhoto" class="button">Change photo</button>
                </div>
            </div>
            <!-- End Modal content -->
...
const { changeImageUrl } = sectionStore

// Declare props
const props = defineProps(['currentComponent']);

// Store image url in ref
const imageUrl = ref(props.currentComponent.styles.image);

// Add photo to section
const addPhoto = () => {
    changeImageUrl(imageUrl, props.currentComponent.id)
